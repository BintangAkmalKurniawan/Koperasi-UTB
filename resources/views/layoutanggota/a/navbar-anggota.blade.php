              ...
              <div class="flex justify-between items-center h-16">
                  ...
                  <div class="hidden lg:flex items-center space-x-8">
                      ...
                      <div class="relative group">
                          ...
                          {{-- LOGOUT --}}
                          <div
                              class="absolute top-full -left-10 w-50 bg-white shadow-xl rounded-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                              <a class="flex items-center space-x-3 px-4 py-3 text-green-800 hover:bg-gray-50 hover:text-green-600 transition-colors duration-200"
                                  href="/profil-anggota">
                              ...
                              <form method="POST" action="{{ route('logout') }}">
                                  @csrf
                                  <button type="submit"
                                      class="flex items-center space-x-3 px-4 py-3 text-red-800 hover:bg-gray-50 hover:text-red-600 transition-colors duration-200">
                              ...
                              {{-- <a
                    class="flex items-center space-x-3 px-4 py-3 text-red-800 hover:bg-gray-50 hover:text-red-600 transition-colors duration-200"
                    href="https://bantengputihlamongan.com/pengaduan"
                  >
