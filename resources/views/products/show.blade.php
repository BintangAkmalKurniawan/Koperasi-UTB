...
<body class="bg-gray-100">
    @include('Layout.menu')
    <!-- Header hijau -->
    <header class="relative top-20 left-0 right-0 bg-[#49A84E] text-white py-6 shadow">
        <div class="w-full px-4 sm:px-6 lg:px-12 text-center">
            <h1 class="text-3xl md:text-4xl font-extrabold tracking-wide">Detail Produk</h1>
        </div>
    </header>

    <main class="w-full px-4 sm:px-6 lg:px-12 mt-[100px] mb-12">
                ...
                <div class="space-y-4">
                    @if ($product->images->count())
                        ...
                        <div class="w-full bg-gray-100 rounded-2xl overflow-hidden border border-gray-200 shadow-md">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-green-600 text-white text-xs font-semibold px-3 py-1 rounded-lg shadow">
